...
<div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
    ...
    <form class="user" action="{{ route('data-update', ['id' => auth()->user()->id])}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-12 col-md-4">
                            <div class="upload mt-4 pr-md-4">
                                <input type="file" id="input-file-max-fs" class="dropify" data-default-file="../src/assets/img/profile-30.png" data-max-file-size="2M" />
